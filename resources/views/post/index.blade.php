                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex flex-col mb-4">
                                <div class="flex flex-col md:flex-row">
                                    <div class="item-1 h-48 md:basis-1/3">
                                        @if($post->image_main)
                                    ...
                                    <div class="item-2 md:basis-2/3">
                                        <p class="mt-4 text-gray-600 py-4">{{Str::limit($post->body,220,"...")}}　　
                            ...
                            <div class="flex flex-col md:flex-row">
                                <div class="item-3 md:basis-1/2 border-solid border-gray-400 rounded-md">
                                ...
                                <div class="item-4 md:basis-1/2 border-solid border-gray-400 rounded-md">
